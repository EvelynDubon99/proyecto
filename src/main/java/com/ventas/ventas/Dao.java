...
public class Dao {
    ...
    public void save(Telefono nuevo) throws IOException {
        ...
        insertActor.withSchemaName("DEV").withTableName("BODEGA").usingColumns("existencia", "precio_lista",
    ...
    public void saveCliente(Cliente ci) {
        SimpleJdbcInsert insertActor = new SimpleJdbcInsert(jdbcTemplate);
        insertActor.withSchemaName("DEV").withTableName("CLIENTES").usingColumns("nombre", "apellido", "nit", "correo",
    ...
    public void insertarPedido(Pedido nuevo) throws IOException {
        SimpleJdbcInsert insertActor = new SimpleJdbcInsert(jdbcTemplate);
        insertActor.withSchemaName("DEV").withTableName("PEDIDO").usingColumns("ID_CLIENTE", "CANTIDADP", "CANTIDADP_A",
                "ID_BODEGA", "TOTAL_C");
        BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(nuevo);
        insertActor.execute(param);
    }
    ...
    public void crearU(Usuarios nuevo) throws IOException {
        ...
        SimpleJdbcInsert insertActor = new SimpleJdbcInsert(jdbcTemplate);
        insertActor.withSchemaName("VDEV").withTableName("USUARIO").usingColumns("usuario", "contraseña",
                "id_tipo_usuario");
        BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(nuevo);
        insertActor.execute(param);
    }
